        ...
        <div>
            <div className="flex mn:flex-col md:flex-row justify-evenly bg-greenGora">
                ...
                <div className="flex flex-col justify-center items-center p-2">
                    <Link className="text-pinkLightGora hover:text-orangeGora mn:text-md md:text-lg py-2" href="#adopciones">
                        Adopciones
                    </Link>
                    <Link className="text-pinkLightGora hover:text-orangeGora mn:text-md md:text-lg py-2" href="https://gorafundacion.org/">
                        Tienda Gora
                    </Link>
                    <Link className="text-pinkLightGora hover:text-orangeGora mn:text-md md:text-lg py-2" href="https://nibi.com.co/fundaciones/id/GORA_FUNDACI%C3%93N">
                        Ayúdanos
                    </Link> 
                </div>
            ...
            <div className="flex mn:flex-col md:flex-row justify-evenly bg-greenGora text-center pt-4 pb-4">
                <div className="flex mn:flex-col md:flex-row justify-center items-center">
                    <p className="mn:mt-2 md:mt-0 leading-4 text-pinkLightGora text-sm">
