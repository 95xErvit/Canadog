    ...
    return(
        <div>
            <div className="flex mn:flex-col md:flex-row justify-evenly bg-greenCanadog py-4">
                <div className=" flex flex-col text-center items-center border-none bg-greenCanadog mn:p-0 md:p-2 xl:p-4">
                    <Link href="/" className="flex justify-center items-center pt-4">
                        <Image className='rounded-full' src="/LogoCanadog.jpg" width="150" height="60" alt="Logo Gora"/>
                    </Link>
                    ...
                    <div className="flex justify-center items-center py-3">
                        ...
                        <a href="https://www.tiktok.com/@gorafundacion" className="text-pinkLightGora hover:text-pinkGora hover:scale-125 px-2">
                ...
                <div className="flex mn:flex-col md:flex-cols justify-evenly text-center mn:text-md md:text-xl p-2">
                ...
                <div className="flex mn:flex-col md:flex-cols justify-center text-center gap-4 mn:text-md md:text-lg p-2">
                    <div className='space-y-2'>
                        <p className="text-white text-start text-xl">
                            Contactanos:
                        </p>
                        <Link href='https://wa.me/+573104684683' target='_blank'>
                    ...
                    <div className='space-y-2'>
                        ...
                        <a href="https://www.instagram.com/canadog_store/" target='_blank' className="flex items-center space-x-1">
                            ...
                            <span className="text-white text-xl">canadog_store</span>
                        </a> 
                    </div>    
                </div>
            </div>
            ...
            <div className="flex mn:flex-col md:flex-row justify-evenly bg-greenCanadog text-center pt-4 pb-4">
                ...
                <div className="flex justify-center items-center space-x-2">
                    ...
                    <Link href="https://www.instagram.com/innmindsco/" target='_blank' className="flex items-center mn:m-4 md:m-0">
