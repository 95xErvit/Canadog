                ...
                <div className=" flex mn:flex-col md:flex-row text-center items-center border-none bg-greenGora mn:py-2 xl:py-4">
                    <div className="w-full flex justify-center md:justify-start">
                        <p className="mn:text-xs lg:text-md mn:mt-2 md:mt-0 leading-4">
                            <strong className="font-bold text-md text-OrangeLightGora"
                    ...
                    <div className="flex justify-center items-center mn:space-x-2 md:space-x-5">
                        <a href="#" className="text-OrangeLightGora hover:text-RedLightGora hover:scale-90">
                        ...
                        <a href="https://www.instagram.com/gorafundacion/" className="text-OrangeLightGora hover:text-RedLightGora hover:scale-90">
                        ...
                        <a href="https://gorafundacion.org/" className="text-OrangeLightGora hover:text-RedLightGora hover:scale-90">
